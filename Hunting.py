...
def Hunting(name, i,  mood, health, eat_sat, drink_sat, sleep_sat):
     print(' ')
     print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
     print(' ')
     ...
     if hunt_r >= 0 and hunt_r <=60 :
          ...
          if anim_r >= 0 and anim_r <=10 :
               ...
               Hunting_dop(name, prof, i,  mood, health, eat_sat, drink_sat, sleep_sat)
...
def Hunting_dop(name, prof, i,  mood, health, eat_sat, drink_sat, sleep_sat):        #Основная функция
     print(' ')
     print('1. Атаковать')
     if i < 2 :
     ...
     if ch_n == '1' :
          ...
          Fighting(name, prof,  mood, health, eat_sat, drink_sat, sleep_sat)
     elif ch_n == '2' :
...
def Fighting(name, prof,  mood, health, eat_sat, drink_sat, sleep_sat) :             #Собственно сам файтинг
     print(' ')
     ...
     if hunt_r_fl == 1 :
          eat_sat -= 3                                                               #Необходимые изменения
          drink_sat -= 3
          sleep_sat -= 3
          mood += 4
     elif hunt_r_fl == 0:
